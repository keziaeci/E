<x-admin-layout>
    ...
    <div class="mx-10 my-5 flex">
        {{-- <a href="{{ route('master-pengembalian-create') }}" class="inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm bg-indigo-600 text-white hover:bg-indigo-700 focus:relative" title="Edit Product">
        ...
        <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
            <thead class="ltr:text-left rtl:text-right">
                <tr>
                    ...
                    <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Tanggal Kembali</th>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="odd:bg-gray-50">
                    <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">{{ $pengembalian->peminjaman->user->name }}</td>
                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ date('h:m:s ,d-m-Y', strtotime($pengembalian->tanggal_kembali)) }}</td>
                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ $pengembalian->peminjaman->buku->judul }}</td>
                    ...
                    <td class="whitespace-nowrap px-4 py-2">
                        <a
                        href="{{ route('master-pengembalian-detail' , $pengembalian->id) }}"
