<x-admin-layout>
    ...
    <div class="mx-10 my-5 flex justify-end">
        <a 
        href="{{ route('master-kategori-create') }}" 
        ...
        <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="odd:bg-gray-50">
                    <td class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">{{ $kategori->nama }}</td>
                    <td class="whitespace-nowrap px-4 py-2">
                        
                        <span class="inline-flex">

                            <a href="{{ route('master-kategori-edit', $kategori->id) }}"  class="inline-block border-e p-3 text-gray-700 bg-gray-100 rounded hover:bg-gray-200 focus:relative" title="Edit Product">
                                <svg
                            ...
                            <form action="{{ route('master-kategori-delete' , $kategori->id) }}" method="POST">
