        ...
        <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
            <thead class="ltr:text-left rtl:text-right">
                <tr>
                    ...
                    {{-- <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Tenggat Waktu</th> --}}
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="odd:bg-gray-50">
                    ...
                    {{-- @if ($peminjaman->kategoris->isEmpty())
                    ...
                    {{-- <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ $peminjaman->tenggat_waktu }}</td> --}}
                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ $peminjaman->buku->judul }}</td>
                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ $peminjaman->status }}</td>
